...
@EnableJpaRepositories(
        basePackages = "com.example.academyspring2corsi.repository.basicAuth",
...
public class AuthDBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean authEntityManager(EntityManagerFactoryBuilder builder) {
        ...
        return builder
                ...
                .packages("com.example.academyspring2corsi.data.entityBasicAuth")
    ...
    @Bean
    public PlatformTransactionManager authTransactionManager(@Qualifier("authEntityManager")EntityManagerFactory emf) {
